 ...
 */
public abstract class AbstractStreamParser<RESULT> implements Parser<RESULT, InputStream>, Http {

	private ByteBuffer buffer;
	

	protected AbstractStreamParser() {
		resetBuffer();
	}

	abstract protected int getCapacity();

	abstract protected RESULT parse(byte[] source) throws IOException;
